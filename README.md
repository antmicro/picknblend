...
Currently `picknblend` supports Blender 4.5+.
...
For more information regarding Blender supported by the `picknblend` visit the [Blender 4.5 documentation](https://docs.blender.org/manual/en/4.5/).
